                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href="https://iconacademy.uz/" style="mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:14px"><img src="https://iconacademy.uz/full-logo.png" alt="Logo" style="display:block;font-size:18px;border:0;outline:none;text-decoration:none" height="105" title="Logo"></a></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" class="es-text-5791" style="padding:0;Margin:0;padding-top:30px"><h6 style="Margin:0;font-family:Imprima, Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19px;color:#676767"><span class="es-text-mobile-size-14" style="font-size:14px;line-height:21px">Вы получили это сообщение электронной почты, так как пытались войти в учетную запись </span><a target="_blank" href="https://iconacademy.uz" class="es-text-mobile-size-14" style="mso-line-height-rule:exactly;text-decoration:underline;color:#676767;font-size:14px;line-height:21px">Icon Academy</a><span class="es-text-mobile-size-14" style="font-size:14px;line-height:21px">. Если вы этого не делали, просто проигнорируйте это сообщение</span><span style="font-size:14px;line-height:21px">​</span><span class="es-text-mobile-size-14">​</span></h6></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
